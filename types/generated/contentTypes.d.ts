...
export interface ApiAdminAdmin extends Schema.CollectionType {
  ...
  attributes: {
    admin_id: Attribute.UID & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    belongs_to: Attribute.String;
    ord_id: Attribute.String;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    order: Attribute.Relation<
      ...
      'api::order.order'
    >;
    varient_id: Attribute.Relation<
      'api::product.product',
      'oneToMany',
      'api::varient.varient'
    >;
    imglink: Attribute.String & Attribute.Required;
    imglink2: Attribute.String &
      Attribute.DefaultTo<'https://images.emojiterra.com/google/android-nougat/512px/1f6e1.png'>;
    Safety_Score: Attribute.Integer &
      Attribute.Required &
...
export interface ApiVarientVarient extends Schema.CollectionType {
  ...
  attributes: {
    product_varient_id: Attribute.UID & Attribute.Required;
    product_id: Attribute.Relation<
      'api::varient.varient',
      'manyToOne',
      'api::product.product'
